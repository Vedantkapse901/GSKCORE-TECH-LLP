...
export default function HeroContent() {
  ...
  return (
    ...
    >
      ...
      {/* CTA Buttons */}
      <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-24 w-full sm:w-auto">
        <Link href="/contact" className="w-full sm:w-auto">
          <motion.button
            className="w-full px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-orange-primary to-red-orange rounded-lg font-semibold text-base sm:text-lg group relative overflow-hidden"
        ...
        <Link href="/portfolio" className="w-full sm:w-auto">
          <motion.button
            className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 border-2 border-orange-primary text-orange-primary rounded-lg font-semibold text-base sm:text-lg hover:bg-orange-primary/10 group"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
